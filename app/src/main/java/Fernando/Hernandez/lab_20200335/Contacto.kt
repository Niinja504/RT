package Fernando.Hernandez.lab_20200335
...
class Contacto : Fragment() {
    ...
    override fun onCreateView(
        ...
        val but = root.findViewById<Button>(R.id.btn_Contacto)
        but.setOnClickListener {
            Toast.makeText(requireContext(), "20200335@ricaldone.edu.sv", Toast.LENGTH_SHORT).show()
        }
